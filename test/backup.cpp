...
void read_mpu(){
  ...
  (sensor_data)[0] = Wire.read()<<8|Wire.read(); // a_x
  (sensor_data)[1] = Wire.read()<<8|Wire.read(); // a_y
  (sensor_data)[2] = Wire.read()<<8|Wire.read(); // a_z
  (sensor_data)[3] = Wire.read()<<8|Wire.read(); // temp
  (sensor_data)[4] = Wire.read()<<8|Wire.read(); // g_x
  (sensor_data)[5] = Wire.read()<<8|Wire.read(); // g_y
  (sensor_data)[6] = Wire.read()<<8|Wire.read(); // g_z
}
